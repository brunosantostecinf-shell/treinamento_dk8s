...
## Criando a chave privada e o CSR do usuário platform
...
metadata:
  name: platform
spec:
  request: 
...
## Criando o ClusterRole e ClusterRoleBinding do platform
...
## Aplicando os ClusterRole e ClusterRoleBinding
...
## Configurando o kubeconfig para o usuário platform
...
## Testando o acesso do usuário platform
...
## Criando a chave privada e o CSR do usuário admin
...
## Aprovando e extraindo o certificado do admin
...
## Criando o ClusterRole e ClusterRoleBinding do admin
...
## Aplicando os ClusterRole e ClusterRoleBinding do admin
...
## Testando o acesso do usuário admin
